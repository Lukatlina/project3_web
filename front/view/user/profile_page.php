...
<head>
    ...
    <script src="<?= BASE_PATH ?>/front/js/user/user_profile.js"></script>
    <script src="<?= BASE_PATH ?>/front/js/auth/auth_password_check.js"></script>
    <script src="<?= BASE_PATH ?>/front/js/auth/auth_nickname_check.js"></script>
</head>
<body style="overflow: auto;">
    <div id="next">
        <header class="user-data-header">
                <a class="user-data-image" onclick="location.href='<?= BASE_PATH ?>/front/view/user/profile_page.php'">
            ...
            <div class="screen-box">
                ...
                <dl class="user-data-box">
                    ...
                    <div class="user-data-item">
                        ...
                        <dd class="current-user-data">
                            <span id="modified-name-text"><?php echo $lastName . $firstName;?></span>
                ...
                <section class="box-section" style="margin-bottom: 0px; text-align: center;">
                    <button type="submit" class="member-withdraw-button" onclick="location.href='<?= BASE_PATH ?>/front/view/user/withdraw_page.php'">위버스 계정 탈퇴하기</button>
                </section>
            </div>
        </div> 
    </div>
