        ...
        <div id="next">
            <div class="signin-screen">
                <div class="signin-image">
                    <img
                        src="<?= BASE_PATH ?>/res/image/weverse_account.png"
                        width="201"
                        height="18"
                        alt="weverse account"
                ...
                <div class="signin-box">
                    ...
                    <div class="signin-nickname-area">
                        <form
                            ...
                            action="<?= BASE_PATH ?>/front/view/auth/register_process.php">
                            <div class="form-box">
                            ...
                            <div class="signin-button-area">
                                ...
                                <button
                                    ...
                                    onclick="location.href='<?= BASE_PATH ?>/front/view/auth/register_password_page.php'">
                                    이전
                                </button>
                            </div>
                        </div>
